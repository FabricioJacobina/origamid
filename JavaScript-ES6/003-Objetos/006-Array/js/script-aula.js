...
carros[1]; // Mustang
carros[2] = "Ferrari"; // Substitui Honda
carros[10] = "Parati";
carros.length; // 11
...
idades.sort(); // [1, 12, 21, 32, 33, 43, 8] organiza de um por um

const carros3 = ["Ford", "Fiat", "VW"];
carros3.unshift("Honda", "Kia"); // 5
carros3; // ['Honda', 'Kia', 'Ford', 'Fiat', 'VW']; Adiciona no início

carros3.push("Ferrari"); // 6
carros3; // ['Honda', 'Kia', 'Ford', 'Fiat', 'VW', 'Ferrari']; Adiciona no final

const carros4 = ["Ford", "Fiat", "VW", "Honda"];
const primeiroCarro = carros4.shift(); // 'Ford' Remove o primeiro item
carros4; // ['Fiat', 'VW', 'Honda'];

const ultimoCarro = carros4.pop(); // 'Honda' Remove o ultimo item
carros4; // ['Fiat', 'VW'];

const carros5 = ["Ford", "Fiat", "VW", "Honda"];
carros5.reverse(); // ['Honda', 'VW', 'Fiat', 'Ford'];

// [].splice adiciona valores na array a partir do index. Remove a quantidade de itens que for passada no segundo parâmetro (retorna esses itens).
...
linguagens.indexOf("js"); // 2 Procura o primeiro item
linguagens.lastIndexOf("js"); // 5  Procura o último item
...
const cloneLinguagens3 = linguagens3.slice();
