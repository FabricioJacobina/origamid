...
const frutas0 = ["Uva", "Maçã", "Banana"];
frutas0.mostreThis(); // ['Uva', 'Maçã', 'Banana']

Array.prototype.pop.call(frutas0); // Remove Banana
frutas0.pop(); // Mesma coisa que a função acima
...
filtro; // Retorna os itens que possuem ativar
...
const li0 = document.querySelectorAll("li");

function itemPossuiAtivo(item) {
  return item.classList.contains("ativo");
}

const filtro1 = Array.prototype.filter.call(li0, itemPossuiAtivo);
const filtro2 = Array.prototype.filter.apply(li0, [itemPossuiAtivo]);
...
carro0.acelerar(100, 20);
// Ford acelerou 100 em 20

const honda = {
  marca: "Honda",
};
const acelerarHonda = carro0.acelerar.bind(honda);
